...
class HomeServiceBookingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HomeServiceBookingScreen> createState() => _HomeServiceBookingScreenState();
}
...
class _HomeServiceBookingScreenState extends ConsumerState<HomeServiceBookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Book a Care Service', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
        centerTitle: true,
      ),
      body: Form(
        key: _formKey,
          ...
          children: [
                ...
                children: [
                  ...
                  _buildCardSection(
                    ...
                    child: GridView.count(
                      ...
                      children: [
                        _buildServiceTile(context, 'General Nursing', Icons.local_hospital_rounded, bookingState),
                        _buildServiceTile(context, 'Elderly Care', Icons.elderly_rounded, bookingState),
                        _buildServiceTile(context, 'Post Surgery', Icons.wheelchair_pickup_rounded, bookingState),
                        _buildServiceTile(context, 'ICU Nurse', Icons.masks_rounded, bookingState),
                        _buildServiceTile(context, 'Attendant', Icons.hail_rounded, bookingState),
                      ],
                    ),
                  ),
                  const SizedBox(height: 16),
                  _buildCardSection(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (val) => ref.read(homeServiceBookingProvider.notifier).updateField(medicalCondition: val),
                    ),
                  ),
                  const SizedBox(height: 16),
                  _buildCardSection(
                    ...
                    child: BookingServiceDuration(bookingState: bookingState, daysController: _daysController),
                  ),
                  const SizedBox(height: 16),
                  _buildCardSection(
                    context,
                    ...
                    child: Wrap(
                      ...
                      runSpacing: 8,
                      children: [
                        _buildTimeChip(context, 'Morning (6am - 12pm)', Icons.wb_sunny_rounded, bookingState),
                        _buildTimeChip(context, 'Afternoon (12pm - 5pm)', Icons.sunny, bookingState),
                        _buildTimeChip(context, 'Evening (5pm - 9pm)', Icons.wb_twilight_rounded, bookingState),
                        _buildTimeChip(context, 'Night (9pm - 6am)', Icons.dark_mode_rounded, bookingState),
                      ],
                    ),
                  ),
                  const SizedBox(height: 16),
                  _buildCardSection(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (val) => ref.read(homeServiceBookingProvider.notifier).updateField(additionalNotes: val),
                    ),
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: colorScheme.shadow.withValues(alpha: 0.04), blurRadius: 10, offset: const Offset(0, -4))],
              ),
              child: SizedBox(
                height: 50,
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Submit Booking Request', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
  ...
  Widget _buildServiceTile(BuildContext context, String title, IconData icon, HomeServiceBookingModel state) {
    ...
    return InkWell(
      onTap: () => ref.read(homeServiceBookingProvider.notifier).updateField(selectedServiceType: title),
  ...
  Widget _buildTimeChip(BuildContext context, String label, IconData icon, HomeServiceBookingModel state) {
    ...
    return InkWell(
      onTap: () => ref.read(homeServiceBookingProvider.notifier).updateField(timePreference: label),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(label, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: isSel ? colorScheme.onPrimary : null)),
          ],
        ),
      ),
    );
