    ...
    return Column(
      ...
      children: [
        const StepHeader(
          ...
          desc: 'Provide documentation for validation processing.',
        ),
        ...
        DocumentUploadTile(
          ...
          onUpload: (path) {
            controller.uploadDocument("Medical Reports", path);
          },
        ...
        DocumentUploadTile(
          ...
          onUpload: (path) {
            controller.uploadDocument("Prescription", path);
          },
