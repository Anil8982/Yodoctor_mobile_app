    ...
    return Column(
      ...
      children: [
        ...
        DocumentUploadTile(
          ...
          isRequired: true,
          hasError: controller.showValidationError && controller.getUploadedDoc('Profile Photo') == null,
        ...
        DocumentUploadTile(
          ...
          isRequired: true,
          hasError: controller.showValidationError && controller.getUploadedDoc('Government ID Proof') == null,
