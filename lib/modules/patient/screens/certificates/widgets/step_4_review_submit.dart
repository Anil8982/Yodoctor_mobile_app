...
class Step4ReviewSubmit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const StepHeader(title: 'Review Application', desc: 'Confirm accuracy of entries before submitting to evaluation channels.'),
        ...
        _buildReviewListCard(
          ...
          items: [
            ...
            {'label': 'Current Active Prescriptions', 'value': controller.medicationsController.text.isNotEmpty ? controller.medicationsController.text : 'None'},
          ],
        ),
        const SizedBox(height: 20),
        ...
        Theme(
          data: theme.copyWith(checkboxTheme: theme.checkboxTheme.copyWith(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)))),
          child: CheckboxListTile(
            value: confirmDisclaimer,
            onChanged: onDisclaimerChanged,
            title: Text('I legally verify that my submitted profile fields are accurate.', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
  ...
  Widget _buildReviewListCard(BuildContext context, {required String title, required List<Map<String, String>> items}) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold, color: colorScheme.primary)),
        ...
        Container(
          ...
          child: ListView.separated(
            ...
            separatorBuilder: (context, index) => Divider(color: colorScheme.outlineVariant.withValues(alpha: 0.4), height: 24),
                ...
                children: [
                  Expanded(
                    ...
                    child: Text(
                      ...
                      style: theme.textTheme.labelSmall?.copyWith(color: colorScheme.onSurfaceVariant, fontSize: 10, letterSpacing: 0.6),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
                    flex: 5,
                    child: Text(items[index]['value']!, style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600, color: colorScheme.onSurface)),
                  ),
                ],
              );
            },
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Center(child: Icon(Icons.description_rounded, color: colorScheme.primary, size: 20)),
                ),
                const SizedBox(width: 12),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(docKey, style: theme.textTheme.bodySmall?.copyWith(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 2),
                    Text(fileName, style: theme.textTheme.labelSmall?.copyWith(color: colorScheme.onSurfaceVariant)),
                  ],
                ),
              ],
            ),
