...
class SubscriptionVerificationShimmer extends StatelessWidget {
  ...
  Widget _buildBannerShimmer() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.grey.transparency(0.1),
  ...
  Widget _buildPlanCardShimmer() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.grey.transparency(0.05),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: AppTheme.grey.transparency(0.1)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        height: 32,
                        decoration: BoxDecoration(
                          color: AppTheme.grey.transparency(0.08),
  ...
  Widget _buildButtonShimmer() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.grey.transparency(0.08),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: AppTheme.grey.transparency(0.15)),
      ),
    );
  }
}
