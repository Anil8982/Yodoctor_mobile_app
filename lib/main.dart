...
import 'modules/patient/controllers/patient_search_controller.dart';
import 'modules/patient/controllers/profile_controller.dart';
import 'modules/patient/controllers/DoctorDetailController.dart';
import 'modules/patient/controllers/book_appointment_controller.dart';
import 'modules/auth/controllers/doctor_register_controller.dart';
import 'modules/auth/controllers/doctor_login_controller.dart';
    ...
    ProviderScope(
      child: MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(create: (_) => FamilyController()),
          ChangeNotifierProvider(create: (_) => AppointmentHistoryController()),
          ChangeNotifierProvider(create: (_) => DoctorDetailController()),
          ChangeNotifierProvider(create: (_) => BookAppointmentController()),
          ChangeNotifierProvider(create: (_) => DoctorRegisterController()),
          ChangeNotifierProvider(create: (_) => DoctorLoginController()),
        ],
        child: const YoDoctorApp(),
      ),
    ),
